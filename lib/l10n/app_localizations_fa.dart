...
class AppLocalizationsFa extends AppLocalizations {
  ...
  @override
  String get noNotesSelectedToShare => 'یادداشتی برای اشتراک‌گذاری انتخاب نشده است';

  @override
  String get nothingToShare => 'چیزی برای اشتراک‌گذاری نیست';
